...
[⬇️ 下载 Codex Meter v1.5.1（macOS Universal 2）](https://github.com/JTXYH/codex-meter/releases/download/v1.5.1/CodexMeter-1.5.1-macOS.zip)

该版本同时支持 Apple Silicon 和 Intel Mac。下载 ZIP 后解压，将 `CodexMeter.app` 拖入“应用程序”目录即可。[查看 v1.5.1 发布说明](https://github.com/JTXYH/codex-meter/releases/tag/v1.5.1)。
...
2. 启动 Codex Meter；菜单栏会出现应用图标，并优先显示 5 小时剩余额度（仅有周额度时自动回退）。
