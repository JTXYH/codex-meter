/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8dd35574f6759b2942625c7874d409da)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	UPDATE_RATE_LIMITER: RateLimit;
	GITHUB_OWNER: "JTXYH";
	GITHUB_REPO: "codex-meter";
	ASSET_PREFIX: "CodexMeter-";
	GITHUB_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_OWNER" | "GITHUB_REPO" | "ASSET_PREFIX" | "GITHUB_TOKEN">> {}
}
